...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 border-r border-[#262626] bg-[#0F0F0F] flex flex-col h-screen sticky top-0 shrink-0">
      {/* Logo */}
      ...
      {/* User/Status Footer */}
      <div className="p-4 border-t border-[#262626] bg-[#0B0B0B] flex items-center justify-between text-xs text-[#737373] font-mono">
